      ...
      <div className="crt">
        <div className="centeredContainer">
          <Carouselka
            images={images}
            width={300}
            className="carouselka"
            ascii={sonder_preview}
          />
          ...
          >
            ...
            social activities, and earn rewards for their participation. This
            app was created to combat the growing loneliness epidemic, which has
            been exacerbated by the increasing use of technology and the
            isolation caused by the COVID-19 pandemic. While the app is still in
        ...
        <div className="centeredContainer">
          <AsciiButton
            onclick={() => {window.location.href="https://github.com/Jazzik/LonelyApp"}}
            size={20}
            label="    Github rep   "
          ></AsciiButton>
        </div>
        ...
        <div className="centeredContainer">
          <AsciiButton
            onclick={() => {
              window.location.href = 'https://github.com/ZizMich/LonelyAppBackEnd';
            }}
            size={20}
            label="    Github rep   "
          ></AsciiButton>
